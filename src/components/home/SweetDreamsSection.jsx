    ...
    >
      <Container>
        ...
        >
          ...
          <span style={{ color: "white", fontFamily: "Gilroy-Bold" }}>
            Bakery/Pastry Shop
          </span>{" "}
          Showcase
        </Typography>
          ...
          <Grid item xs={12} sm={6}>
            <Box sx={{ p: 3, borderRadius: "8px" }}>
              ...
              >
                ...
                corner of the interiorVerse Showcase Collection. Our
                Bakery/Pastry Shop VR model is a charming blend of rustic charm
                and modern design, crafted to evoke the aroma of freshly baked
                goods and the{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
                  warmth of a neighborhood
                </span>{" "}
                bakery. Let’s take a delicious virtual journey through this
                delectable space, where every detail is designed to{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
                  delight and inspire
                </span>
                .
              ...
              >
                Imagine stepping into a bakery where the{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
                  comforting smell of freshly baked{" "}
                </span>
                bread fills the air. Our Bakery/Pastry Shop captures that
                nostalgic essence, transporting you to a place where simplicity
                meets sophistication. The{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
                  {" "}
                  wooden shelves lined with pastries
                </span>
                , the inviting display counter, and the cozy seating area create
                an environment that feels both{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
              ...
              >
                ...
                <ul>
                  <li>
                    ...
                    Decor: Rustic wooden accents and vintage-inspired decor
          ...
          <Grid item xs={12} sm={6}>
            <Box sx={{ p: 3, borderRadius: "8px" }}>
              ...
              >
                ...
                Display Counter: Showcasing an array of delicious pastries and
                baked goods,{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
                  tempting you with every glance.
                </span>
                <ul>
                  <li>
                    <span style={{ color: "white", fontWeight: "bold" }}>
                  ...
                  <li>
                    ...
                    Kitchen: A behind-the-scenes look at the modern, efficient
              ...
              >
                ...
                own bakery venture, interiorVerse is here to{" "}
                <span style={{ color: "white", fontWeight: "bold" }}>
                  {" "}
                  bring your visions
                </span>
